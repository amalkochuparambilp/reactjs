...
const App = () => {
  ...
  const [energy, setEnergy] = useState(2354);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setEnergy((prevEnergy) => Math.min(prevEnergy + 2, 1000));
      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="relative mt-4" onClick={handleClick}>
            <img src='https://e7.pngegg.com/pngimages/622/809/png-clipart-university-of-santo-tomas-alpha-kappa-rho-fraternity-akrho-radio-others-miscellaneous-text.png' width={256} height={256} alt="notcoin" />
            {clicks.map((click) => (
              <div
                key={click.id}
